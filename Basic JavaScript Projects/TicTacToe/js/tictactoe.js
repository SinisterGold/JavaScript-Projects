...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //squareNumber and activePlayer are concatenated togther and added to array.
...
//This function pares the selectedSquares array to search for win conditions.
...
function checkWinConditions() {
    ...
    //This condition checks for a tie. If none of the moves above conditions are met and
